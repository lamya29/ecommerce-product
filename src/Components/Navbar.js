        ...
        <nav className="navbar">
            ...
            <div className='menu-icon' onClick={handleClick}>
              {click ? <FaTimes /> : <FaBars />}
                ...
                <ul className={click ? 'bar-icon active ' : 'bar-icon '}>
                    <li className="nav-item" onClick={closeMobileMenu}>Collections</li>
                    <li    className="nav-item"  onClick={closeMobileMenu}>Men</li>
                    <li   className="nav-item"  onClick={closeMobileMenu}>Women</li>
                    <li   className="nav-item"  onClick={closeMobileMenu}>About</li>    
                    <li   className="nav-item"  onClick={closeMobileMenu}>Contact</li>
                </ul>
